...
{
    public class EjectStageOperation
    {
            /// <summary>
            ...
            /// </summary>
            public void CallEjectStageOperation()
            {
                ...
                var methodStartSample = ConnectionManager._methodCollectionPlayControl.First(n => n.DisplayName.ToString().Equals(ViCellBlu.BrowseNames.EjectStage)); //EjectStage
